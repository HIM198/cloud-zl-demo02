...
var App = function () {
    ...
    var globalPluginsPath = 'styles/skin_default/plugins/';

    var globalCssPath = 'styles/skin_default/css/';
    ...
    return {
        ...
        blockUI: function (options) {
            ...
            if (options.animate) {
                ...
                html = '<div class="loading-message ' + (options.boxed ? 'loading-message-boxed' : '') + '"><img src="../styles/img/loading/loading-spinner-grey.gif" align=""></div>';
            } else if (options.textOnly) {
                html = '<div class="loading-message ' + (options.boxed ? 'loading-message-boxed' : '') + '"><span>&nbsp;&nbsp;' + (options.message ? options.message : 'LOADING...') + '</span></div>';
            } else {
                html = '<div class="loading-message ' + (options.boxed ? 'loading-message-boxed' : '') + '"><img src="../styles/img/loading/loading-spinner-grey.gif" align=""><span>&nbsp;&nbsp;' + (options.message ? options.message : 'LOADING...') + '</span></div>';
            }
        ...
        startPageLoading: function (options) {
            if (options && options.animate) {
                ...
                $('.page-loading').remove();
                $('body').append('<div class="page-loading"><img src="../styles/img/loading/loading-spinner-grey.gif"/>&nbsp;&nbsp;<span>' + (options && options.message ? options.message : 'Loading...') + '</span></div>');
            }
        },
...
var addTabs = function (options) {
    ...
    if (findTabPanel(pageId) === null) {
        ...
        var $title = $('<a href="javascript:void(0);"><i class="'+options.icon+' tab-icon"></i> </a>').attr(pageIdField, pageId).addClass("menu_tab");
